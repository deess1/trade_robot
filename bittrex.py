...
CF_COOKIE = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'     # CloudFlare security cookie
...
#PROXY = {"http": "http://10.100.01.88:3229", "https": "https://10.100.01.88:3229"}
PROXY = None    
...
class Bittrex(object):
    ...
    def api_query(self, method, options=None):
        ...
        return requests.get(
            ...
            verify=False,
            proxies=PROXY,
            cookies=dict(__cfduid=CF_COOKIE)
        ).json()
